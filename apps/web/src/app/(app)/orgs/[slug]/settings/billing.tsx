                ...
                <Table>
                    ...
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell className='text-right'>{billing.projects.price.toLocaleString('en-US', {
                                style: 'currency',
                                currency: 'USD'
                            })} ({billing.projects.unit} each)</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell>Amount of seats</TableCell>
                            <TableCell className='text-right'>{billing.seats.amount}</TableCell>
                            <TableCell className='text-right'>{billing.seats.price.toLocaleString('en-US', {
                                style: 'currency',
                                currency: 'USD'
                            })} ({billing.seats.unit} each)</TableCell>
                        </TableRow>
                    </TableBody>
                    <TableFooter>
                        <TableRow>
